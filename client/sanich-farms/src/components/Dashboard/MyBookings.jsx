    ...
    <div className="space-y-6">
      ...
      {filteredBookings.length === 0 ? (
        <div className="text-center py-12 bg-white rounded-xl shadow-sm">
          ...
          <Link to="/services" className="inline-flex items-center gap-2 bg-green-600 text-white px-6 py-2 rounded-lg font-medium hover:bg-green-700 transition duration-200">
            <FiCalendar size={16} />
            Book a Service
          </Link>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid gap-4">
            {filteredBookings.map((booking) => (
              <div key={booking.id} className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition duration-200">
