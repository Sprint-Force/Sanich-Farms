  ...
  return (
    <div className="hidden lg:flex items-center justify-between">
      ...
      <Link to="/" className="flex items-center gap-2 flex-shrink-0">
        ...
        />
        <span className={`${getTypographyClasses('logo')} text-[#00B207] hidden lg:block`}>
          Sanich Farms
        </span>
      </Link>
      ...
      {/* Icons & User Info/Login (Desktop) - Reduced Spacing */}
      <div className="flex items-center gap-4 text-gray-700 text-lg flex-shrink-0">
        <Link 
          to="/wishlist" 
