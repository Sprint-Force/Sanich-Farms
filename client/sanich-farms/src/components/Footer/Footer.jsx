...
//   return (
//     <footer className='bg-[#002603] text-white font-poppins'>
//       {/* Newsletter Section */}
//       <div className='bg-[#002603] px-6 md:px-10 lg:px-16 py-10 md:py-16 border-b border-green-800'>
//         <div className='max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left'>
//           <div>
//             <h2 className='text-2xl font-bold mb-2'>Subscribe to our Newsletter</h2>
//             <p className='text-gray-300 text-sm'>Get the latest updates and offers.</p>
//           </div>
//           <div className='w-full md:w-auto flex flex-col md:flex-row items-center'>
//             <input 
//               type='email'
//               placeholder='Your email address'
//               className='w-full md:w-80 px-6 py-4 rounded-t-full md:rounded-t-none md:rounded-l-full border border-gray-300 focus:outline-none focus:border-[#00B207] text-gray-700'
//             />
//             <button className='w-full md:w-auto bg-[#00B207] hover:bg-green-600 text-white px-8 py-4 rounded-b-full md:rounded-b-none md:rounded-r-full font-semibold transition-colors duration-300'>
//               Subscribe
//             </button>
//           </div>
//         </div>
...
//       {/* Footer Grid */}
//       <div className='max-w-7xl mx-auto px-6 md:px-10 lg:px-16 py-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10'>
        
//         {/* About Us */}
//         <div>
//           <h3 className='text-lg font-semibold mb-4'>About SANICH</h3>
//           <p className='text-gray-300 text-sm leading-relaxed'>
//             SANICH FARMS is dedicated to providing quality agricultural products and services with a focus on sustainability and innovation.
//           </p>
//           <div className='flex gap-4 mt-4'>
//             <a href='#' aria-label='Facebook' className='hover:text-[#00B207]'><FaFacebookF /></a>
//             <a href='#' aria-label='Twitter' className='hover:text-[#00B207]'><FaTwitter /></a>
//             <a href='#' aria-label='LinkedIn' className='hover:text-[#00B207]'><FaLinkedinIn /></a>
//             <a href='#' aria-label='YouTube' className='hover:text-[#00B207]'><FaYoutube /></a>
//             <a href='#' aria-label='Instagram' className='hover:text-[#00B207]'><FaInstagram /></a>
//           </div>
//         </div>
...
//             <li><Link to='/' className='hover:text-[#00B207]'>Home</Link></li>
//             <li><Link to='/products' className='hover:text-[#00B207]'>Products</Link></li>
//             <li><Link to='/services' className='hover:text-[#00B207]'>Services</Link></li>
//             <li><Link to='/contact' className='hover:text-[#00B207]'>Contact</Link></li>
//           </ul>
//         </div>
...
//           <ul className='text-gray-300 text-sm space-y-2'>
//             <li><Link to='/account' className='hover:text-[#00B207]'>Account</Link></li>
//             <li><Link to='/orders' className='hover:text-[#00B207]'>Orders</Link></li>
//             <li><Link to='/wishlist' className='hover:text-[#00B207]'>Wishlist</Link></li>
//             <li><Link to='/login' className='hover:text-[#00B207]'>Login</Link></li>
//           </ul>
//         </div>
...
//           <ul className='text-gray-300 text-sm space-y-2'>
//             <li>Email: info@sanichfarms.com</li>
//             <li>Phone: +233 555 123 456</li>
...
//       {/* Copyright */}
//       <div className='text-center py-6 text-gray-400 text-sm border-t border-green-800'>
