  ...
  return (
    ...
    >
      <div className="relative h-48 sm:h-56 overflow-hidden"> {/* Consistent image height */}
        <img
          src={service.image || "https://placehold.co/600x400/4CAF50/FFFFFF?text=Service"}
          alt={service.title}
      ...
      <div className="p-4">
        <h3 className="text-lg sm:text-xl font-semibold text-gray-800 mb-2 truncate">{service.title}</h3> {/* Adjusted font size */}
        ...
        <div className="flex justify-between items-center mt-4">
          <span className="text-lg sm:text-xl font-bold text-green-700">{service.price || 'Price Varies'}</span> {/* Adjusted font size */}
