...
// import React, { useState, useEffect } from 'react';
// import { Link, useNavigate, useLocation } from 'react-router-dom'; // Added useLocation for potential URL category parsing
// import { FiHome, FiChevronRight, FiFilter, FiSliders, FiChevronDown, FiGrid, FiList, FiX, FiArrowLeft } from 'react-icons/fi';
// import ProductCard from '../components/UI/ProductCard';
// import { productsData } from '../data/productsData'; // Ensure this path is correct

// const ShopPage = () => {
//   const navigate = useNavigate();
//   const location = useLocation(); // Used to read category from URL if present
...
//     const categoryFromUrl = pathParts[pathParts.length - 1]; // Gets 'chicks' from /shop/chicks
//     if (categoryFromUrl && categoryFromUrl !== 'shop' && categoryFromUrl !== '') {
//       // Capitalize first letter for display if it's a known category
//       const formattedCategory = categoryFromUrl.charAt(0).toUpperCase() + categoryFromUrl.slice(1);
//       // Check if this category actually exists in your data or options
//       const availableCategories = ['All Categories', 'Chicks', 'Feeds', 'Eggs', 'Vitamins']; // Define your actual categories
//       if (availableCategories.includes(formattedCategory)) {
//         setSelectedCategory(formattedCategory);
//       } else {
//         setSelectedCategory('All Categories'); // Fallback if URL category is invalid
//       }
//     } else {
...
//       {/* Shop Banner/Hero - Already responsive */}
//       <div className="relative w-full h-48 sm:h-64 md:h-80 lg:h-96 overflow-hidden">
//         <img
//           src="https://placehold.co/1920x400/4CAF50/FFFFFF?text=Shop+Our+Products" // Placeholder for shop banner
//           alt="Shop Banner"
...
//       {/* Main Shop Content */}
//       <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
//         {/* Mobile Filter Toggle Button - Hidden on md and up */}
//         <div className="md:hidden flex justify-end mb-6">
//           <button
//             onClick={toggleMobileFilterMenu}
//             className="flex items-center gap-2 bg-green-600 text-white px-5 py-2 rounded-full shadow-md hover:bg-green-700 transition duration-300 focus:outline-none focus:ring-2 focus:ring-green-500"
...
//         {/* Filter and Sort Bar (Desktop View) - Hidden on mobile, shown on md and up */}
//         <div className="hidden md:block bg-white p-4 sm:p-6 rounded-xl shadow-md mb-8 md:mb-12">
//           <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 md:gap-6">
//             {/* Filter Dropdowns - Use flex-wrap to allow items to wrap on smaller screens */}
//             <div className="flex flex-wrap gap-3 md:gap-4 flex-grow">
//               {/* Each select has min-w to ensure it doesn't get too small */}
//               {/* Category Filter */}
//               <div className="relative flex-1 min-w-[150px]">
//                 <select
//                   value={selectedCategory}
...
//             {/* Sort By and Show Count - Use flex-wrap for responsiveness */}
//             <div className="flex flex-wrap gap-3 md:gap-4 md:justify-end">
//               {/* Sort By */}
//               <div className="relative flex-1 min-w-[120px] md:flex-none">
//                 <select
...
//           {/* Active Filters and Results Count - Responsive layout for small screens */}
//           <div className="flex flex-col sm:flex-row items-center justify-between mt-6 pt-4 border-t border-gray-100 gap-4">
//             <div className="flex flex-wrap items-center gap-2">
//               <span className="text-gray-700 font-medium">Active Filters:</span>
//               {activeFilters.length > 0 ? (
...
//         {/* Mobile Filter Sidebar (Off-Canvas Menu) - Hidden on md and up */}
//         <div
//           className={`fixed inset-y-0 left-0 w-64 bg-white z-50 transform transition-transform duration-300 ease-in-out md:hidden
//             ${isMobileFilterMenuOpen ? 'translate-x-0' : '-translate-x-full'}`}
//         >
...
//         {/* Mobile Filter Menu Backdrop - Hidden on md and up, covers content when menu is open */}
//         {isMobileFilterMenuOpen && (
//           <div
//             className="fixed inset-0 bg-black bg-opacity-50 z-40 md:hidden"
//             onClick={toggleMobileFilterMenu} // Close when clicking backdrop
...
//           </div>
//         ) : (
//           <div className="text-center py-10 text-gray-600 text-lg col-span-full"> {/* Added col-span-full for centering */}
//             No products match your current filters.
//           </div>
//         )}

//         {/* Pagination (Placeholder) - Centered on all screens */}
//         <div className="flex justify-center mt-12">
//           <button className="bg-green-600 text-white px-6 py-3 rounded-full shadow-md hover:bg-green-700 transition duration-300">
//             Load More
//           </button>
