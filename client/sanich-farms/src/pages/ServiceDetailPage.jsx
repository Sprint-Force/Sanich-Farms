...
//   const service = servicesData.find(s => s.id === idAsNumber);
...
//         <p className="mb-4">Service not found. Please check the URL or return to our services page.</p>
...
//     // Navigate to the booking page, passing the full service object in state
//     // This allows the booking page to pre-fill service details
//     navigate(`/book-service/${service.id}`, { state: { service: service } });
//   };
