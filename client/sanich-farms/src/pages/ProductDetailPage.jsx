        ...
        <div className="flex items-center justify-between p-4">
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center border border-gray-300 rounded-full overflow-hidden">
              ...
              <span className="px-3 text-base font-semibold text-gray-800">{quantity}</span>
              <button
                onClick={() => handleQuantityChange('increase')}
                className="p-2 hover:bg-gray-100 transition text-gray-700"
                aria-label="Increase quantity"
            ...
            <button
              onClick={handleAddToCart}
              className="flex-grow bg-green-600 text-white px-4 py-2 rounded-full font-semibold text-base flex items-center justify-center gap-2 hover:bg-green-700 transition shadow-md focus:outline-none focus:ring-2 focus:ring-green-500"
              aria-label="Add to cart"
            >
            ...
            <button
              onClick={handleAddToWishlist}
              className="p-3 rounded-full border border-gray-300 text-gray-600 hover:bg-gray-100 hover:text-red-500 transition shadow-md focus:outline-none focus:ring-2 focus:ring-gray-300"
              aria-label="Add to wishlist"
            >
              <FiHeart size={18} />
            </button>
