...
// // import { FiHome, FiChevronRight, FiUser, FiShoppingBag, FiCalendar, FiHeart, FiSettings, FiLogOut } from 'react-icons/fi';
...
// //       <div className="flex flex-1 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8 md:py-12">
// //         {/* Mobile Menu Toggle */}
...
// //         {/* Content Area */}
// //         {/* On mobile, main content is full width. On large screens, it has left margin */}
// //         <main className={`flex-1 w-full ${isMobileMenuOpen ? 'hidden' : 'block'} lg:block lg:ml-8 bg-white rounded-xl shadow-md p-6 sm:p-8`}>
...
// import { Link, Outlet, useLocation, useNavigate } from 'react-router-dom';
// import { FiHome, FiChevronRight, FiUser, FiShoppingBag, FiCalendar, FiHeart, FiSettings, FiLogOut, FiX } from 'react-icons/fi'; // Added FiX for mobile menu close
...
//       {/* Main Dashboard Content Area */}
//       {/* Adjusted padding for mobile, and removed fixed height from this container */}
//       <div className="flex flex-1 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8 md:py-12 relative"> {/* Added relative for mobile sidebar positioning */}
...
//             </button>
//           </div>
//           <nav className="flex-1 space-y-2 overflow-y-auto pb-4"> {/* Added overflow-y-auto for sidebar content */}
//             <Link
//               to="/dashboard"
//               onClick={closeMobileMenu}
//               className={`flex items-center gap-3 px-4 py-2 rounded-lg text-lg font-medium transition-colors duration-200
...
//         {/* Content Area */}
//         {/* On mobile, main content is full width. On large screens, it has left margin */}
//         {/* Conditional rendering to hide main content when mobile menu is open */}
//         <main className={`flex-1 w-full ${isMobileMenuOpen ? 'hidden' : 'block'} lg:block lg:ml-8 bg-white rounded-xl shadow-md p-6 sm:p-8`}>
//           <Outlet /> {/* Renders the nested route component */}
//         </main>
//       </div>
