...
// // src/pages/ServiceBookingPage.jsx
// import React, { useState, useEffect } from 'react';
// import { Link, useNavigate, useParams, useLocation } from 'react-router-dom';
// import { FiHome, FiChevronRight } from 'react-icons/fi';
...
//     customerLocation: '',
//     preferredDateTime: '',
//     serviceType: initialService ? initialService.title : '',
//     optionalMessage: '',
//   });
...
//     if (!formData.customerName || !formData.email || !formData.phone || !formData.customerLocation || !formData.preferredDateTime || !formData.serviceType) {
//       addToast("Please fill in all required fields.", 'error'); // NEW: Error toast
//       return;
//     }
...
//     console.log("Service booking submitted:", bookingDetails);
//     addToast("Your service booking has been submitted! We will contact you shortly.", 'success'); // NEW: Success toast
